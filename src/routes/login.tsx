...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [{ title: "Sign in — LifeTrack" }, { name: "description", content: "Sign in to your LifeTrack account." }] }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen bg-gradient-subtle px-4 py-10">
      <div className="mx-auto max-w-md">
        ...
        <div className="rounded-2xl border bg-card p-7 shadow-card">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to continue your progress.</p>
          ...
          <p className="mt-5 text-center text-sm text-muted-foreground">
            New to LifeTrack? <Link to="/signup" className="font-medium text-primary hover:underline">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
